...
namespace Digimon_Project.Network.Packets
{
    ...
    [NPC(Type = NPCMap.NPC_MUDVILLAGE_ITEM_SHOP)]
    public class NPC_MUDVILLAGE_ITEM_SHOP : NPC
    {
        private string name = "NPC_MUDVILLAGE_ITEM_SHOP";
        ...
        {
            PACKET_NPC_ITEM_SHOP_WRITER write = new PACKET_NPC_ITEM_SHOP_WRITER();
            write.BuyItem(name, npcId, id, quant, sender);
        }
    }
}
