...
namespace Digimon_Project.Network.Packets
{
    ...
    [NPC(Type = NPCMap.NPC_TOY_TOWN_YUKIMIMON)]
    public class NPC_TOY_TOWN_YUKIMIMON : NPC
    {
        ...
        public override void INPC(Client sender, int npcOp)
        {
            ...
            if(sender.Tamer.ItemCount("Tutorial Book 2") == 0)
            {
                sender.Tamer.AddItem("Tutorial Book 2", 1, false);
                Utils.Comandos.Send(sender, "Tutorial Book 2 received! Look your inventory (Press I)");
            ...
            p.Write(new byte[4]);
            p.Write((int)NPCMap.NPC_TOY_TOWN_YUKIMIMON);
            p.Write(npcOp);
