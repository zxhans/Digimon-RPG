...
namespace Digimon_Project.Network.Packets
{
    ...
    [NPC(Type = NPCMap.NPC_HAPPYPRK_PRINCEMAMON)]
    public class NPC_HAPPYPRK_PRINCEMAMON : NPC
    {
        private string name = "NPC_HAPPYPRK_PRINCEMAMON";
        ...
        public override void INPC(Client sender)
        {
            ...
            write.WriteItems(name, sender);
        }
        public override void INPC(Client sender, int npcId, int id, int quant)
        {
            PACKET_NPC_ITEM_SHOP_WRITER write = new PACKET_NPC_ITEM_SHOP_WRITER();
            write.BuyItemWithCoin(name, npcId, id, quant, sender);
        }
    }
}
